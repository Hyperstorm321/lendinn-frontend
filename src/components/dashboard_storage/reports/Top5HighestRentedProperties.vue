        ...
        <v-row justify="center">
            ...
            <v-col cols="12" id="printSection">
                ...
                <section class="ml-5 mb-10 text-center">
                    <h1>Top 5 Highest Rented Properties</h1>
...
export default {
    ...
    mounted(){
        this.top10HighestRentedProperties()
    },
    methods:{
        top10HighestRentedProperties(){
            axios.get('api/top_5_highest_rented_properties_by_city_in_a_year/Caloocan/2020').then(response =>{
